...
export const metadata = {
  ...
  openGraph: {
    ...
    url: '/markets',
    type: 'website',
    images: [{ url: absoluteUrl('/markets/opengraph-image'), width: 1200, height: 630, alt: 'BagDrop markets overview' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'All Markets | BagDrop',
    description: 'Browse every luxury handbag brand and model tracked by BagDrop.',
    images: [absoluteUrl('/markets/opengraph-image')],
  },
}
